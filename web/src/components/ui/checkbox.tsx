...
export function Checkbox(props: CheckboxProps) {
  return (
    <RadixCheckbox.Root
      className={twMerge(
        'flex size-4 shrink-8 items-center justify-center rounded border border-zinc-600 bg-zinc-800 transition-colors hover:border-zinc-500 hover:cursor-pointer',
